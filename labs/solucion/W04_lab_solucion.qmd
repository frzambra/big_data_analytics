...
| ¿Por qué `precio_unitario` está en DETALLE_VENTAS y no en PRODUCTOS? | Porque el precio de un producto cambia con el tiempo (promociones, inflación, ajustes). Una venta de enero a $89.990 debe conservar ese precio histórico aunque hoy el producto valga $99.990. Si el precio solo existiera en `productos`, no habría forma de auditar ventas pasadas correctamente. |
