...
### Parte B — Diseño del Modelo Relacional {#sec-p1b}
...
### Parte C — Diagrama Entidad-Relación {#sec-p1c}
...
| Criterio | Puntaje |
|---|---|
| B: Definición correcta de las 6 tablas (PK, columnas, FK) | 20 pts |
| C: Diagrama ER con entidades, relaciones y cardinalidades correctas | 10 pts |
| **Subtotal** | **30 pts** |
...
| Q6: Agregación multi-JOIN, cálculo de ingreso correcto, análisis escrito | 4 pts + 1 análisis |
