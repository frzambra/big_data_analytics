...
### Paso 2: Catálogo completo ordenado por precio
...
### Paso 4: Clientes por región y segmento
...
### Paso 9: Valor de inventario por categoría — solo las que superan $2.000.000
...
### Paso 12: Detalle completo de ventas (INNER JOIN)
...
### Paso 14: Estado de despachos con nombre del cliente (INNER JOIN)
...
### Paso 15: Ventas con y sin despacho (LEFT JOIN)
...
### Paso 16: Productos sin ventas (LEFT JOIN inverso)
