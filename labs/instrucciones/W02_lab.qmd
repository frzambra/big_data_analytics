...
1. **Parte A** (Lab original Semana 2): Construir tres dashboards en Power BI para distintos niveles organizacionales de TechStyle.
2. **Parte B** (Lab original Semana 3): Auditar la calidad de datos con Power Query y construir el CMI de TechStyle.
...
## Parte A: Tres Dashboards, Tres Usuarios (60 min)
...
## Parte B: Auditoría de Calidad y CMI con Datos Reales (90 min)
