---
title: "Sistemas de Información en el Contexto de Negocios"
...
Unidad 1: Sistemas de Información en el Contexto de Negocios
...
```
   [Sitio Web] → [Base de Datos] → [Análisis] → [Dashboards]
        ↓              ↓               ↓              ↓
   Captura        Almacena        Procesa        Presenta
